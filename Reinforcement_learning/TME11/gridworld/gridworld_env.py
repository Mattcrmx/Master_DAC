...
class GridworldEnv(discrete.DiscreteEnv):
    ...
    def _exploreDir(self, gridmap, state, dir, a, b, c):
        ...
        if nstate[0] < gridmap.shape[0] and nstate[0] >= 0 and nstate[1] < gridmap.shape[1] and nstate[1] >= 0 and \
                gridmap[nstate[0], nstate[1]] != 1:
    ...
    def step(self, action):
        ...
        if npos[0] >= self.current_grid_map.shape[0] or npos[0] < 0 or npos[1] >= self.current_grid_map.shape[1] or \
                npos[1] < 0 or self.current_grid_map[npos[0], npos[1]] == 1:
